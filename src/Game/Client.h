...
// Nos message qu'on affiche � l'�cran
struct TimedMessage
{
	CString message;
	float duration; // Sa vie quil lui reste, on laisse les message 10sec ( si sont rendu trop haut, on les force � closer )
...
public:
	...
	// Les messages chat ou events � printer � l'�cran
   ...
   bool proServer;
	...
	// Quand on se fait toucher, l'�cran devient rouge
