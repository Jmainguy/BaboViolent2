...
void reloadTGA(CTexture * texture)
{
	...
	// Si �a marche pas, oups, on returne 0 comme texture.
	if (file == NULL) 
	{
...
//
// Pour updater, �a check si une texture a �t� modifi� � l'ext�rieur du programme pis �a la replace si cest le cas
//
void			 dktUpdate()
{
