...
Construction d'un font, et permet d'imprimer � l'�cran dans cette
police.
Voici quelque sp�cificit� :
...
public:
	...
	// La liste de display list contenant les caract�re individuel
	unsigned int baseFont;

	// Son ID du dkf
	unsigned int fontID;

	// Les propri�t�es de chaque lettre
...
public:
	...
	// Pour cr�er la police
	int create(CString filename); // attention, ceci ne cr� PAS les display list
	void reloadIt(); // Ceci va la cr�er (parce que �a nous prend le bon context avec le bon renderer)

	// Pour imprimer du texte � l'aide de cette police
